...
class RemotePageSummary < AbstractRemotePageSummary
  ...
  def initialize(id = nil, permissions = nil, space = nil, title = nil, url = nil, parentId = nil, version = nil)
    @id = id
    @permissions = permissions
    @space = space
    @title = title
...
class RemotePage < RemotePageSummary
  ...
  def initialize(id = nil, permissions = nil, space = nil, title = nil, url = nil, parentId = nil, version = nil, content = nil, contentStatus = nil, created = nil, creator = nil, current = nil, homePage = nil, modified = nil, modifier = nil)
    @id = id
    @permissions = permissions
    @space = space
    @title = title
...
#   contentPermissions - Confluence4R::V1::ArrayOf_tns1_RemoteContentPermission
#   type - SOAP::SOAPString
...
# {http://beans.soap.rpc.confluence.atlassian.com}RemoteContentSummary
#   created - SOAP::SOAPDateTime
#   creator - SOAP::SOAPString
#   id - SOAP::SOAPLong
#   modified - SOAP::SOAPDateTime
...
class RemoteContentSummary
  ...
  def initialize(created = nil, creator = nil, id = nil, modified = nil, modifier = nil, space = nil, status = nil, title = nil, type = nil)
    @created = created
    @creator = creator
    @id = id
    @modified = modified
...
#   content - Confluence4R::V1::ArrayOf_tns1_RemoteContentSummary
#   offset - SOAP::SOAPInt
...
class RemoteContentSummaries
  ...
  def initialize(content = nil, offset = nil, totalAvailable = nil)
    @content = content
    @offset = offset
...
#   spacePermissions - Confluence4R::V1::ArrayOf_tns1_RemoteContentPermission
#   type - SOAP::SOAPString
...
# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemotePageSummary
class ArrayOf_tns1_RemotePageSummary < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_xsd_string
class ArrayOf_xsd_string < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteSearchResult
class ArrayOf_tns1_RemoteSearchResult < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteLabel
class ArrayOf_tns1_RemoteLabel < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteContentPermission
class ArrayOf_tns1_RemoteContentPermission < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteContentPermissionSet
class ArrayOf_tns1_RemoteContentPermissionSet < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteComment
class ArrayOf_tns1_RemoteComment < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteContentSummary
class ArrayOf_tns1_RemoteContentSummary < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteSpaceSummary
class ArrayOf_tns1_RemoteSpaceSummary < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteAttachment
class ArrayOf_tns1_RemoteAttachment < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_xsd_anyType
class ArrayOf_xsd_anyType < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteSpace
class ArrayOf_tns1_RemoteSpace < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteSpaceGroup
class ArrayOf_tns1_RemoteSpaceGroup < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemotePermission
class ArrayOf_tns1_RemotePermission < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemotePageHistory
class ArrayOf_tns1_RemotePageHistory < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteNodeStatus
class ArrayOf_tns1_RemoteNodeStatus < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteUser
class ArrayOf_tns1_RemoteUser < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteBlogEntrySummary
class ArrayOf_tns1_RemoteBlogEntrySummary < ::Array
end

# {http://docs.codehaus.org/plugins/servlet/soap-axis1/confluenceservice-v1}ArrayOf_tns1_RemoteSpacePermissionSet
